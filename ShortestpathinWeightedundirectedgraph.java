...
class Solution {
    public List<Integer> shortestPath(int n, int m, int edges[][]) {
        ...
        dist[1] = 0;
        pq.offer(new int[]{1, 0}); // {vertex, distance}
        ...
        // Return the result with the total weight
        path.add(0, dist[n]);
        return path;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.shortestPath(n, m, edges)); // Output: [5, 1, 4, 3, 5]
        
        n = 2;
        m = 1;
        edges = new int[][]{{1, 2, 2}};
        System.out.println(sol.shortestPath(n, m, edges)); // Output: [2, 1, 2]
        
        n = 2;
        m = 0;
        edges = new int[][]{};
        System.out.println(sol.shortestPath(n, m, edges)); // Output: [-1]
    }
}
